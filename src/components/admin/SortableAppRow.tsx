...
export default function SortableAppRow({
  ...
  return (
    <li
      ...
      style={style}
      className={cn(
        'flex items-center gap-2 border border-border bg-card px-2 py-1.5',
      ...
      {editing ? (
        ...
        <>
          ...
          <Button
            ...
            className={cn(
              iconBtnClass,
              'border-1 hover:border-foreground hover:bg-destructive hover:text-destructive-foreground'
            )}
